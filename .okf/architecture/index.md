...
- [Errors](errors.md) — Error types, propagation, and reporting
- [Semantics](semantics.md) — Post-rule transformations, tree folding, Folds trait
- [Config](config.md) — Configuration keys, environment loading, Configurable trait
- [Testing](testing.md) — Test organization, commands, and conventions
- [Bootstrap](bootstrap.md) — Self-hosted boot grammar for parsing EBNF
- [Concurrency](concurrency.md) — Thread safety, shared grammars, parallel parsing
- [Codegen](codegen.md) — Grammar-to-Rust code generation for model structs
- [JSON](json.md) — Grammar and tree serialization to/from JSON
- [Tools](tools.md) — Railroad diagrams, pretty-printing, syntax highlighting
- [Input](input.md) — Cursor trait, StrCursor, tokenizing patterns
